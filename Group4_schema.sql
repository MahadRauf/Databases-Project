...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `buy` VALUES ('user1', 1, '2020-07-04', '23:59');
-- ('user1', 0002, '1766-11-10', '01:37'), ('user1', 0003, '2020-11-30', '21:14'), ('user1', 0004, '2020-01-06', '17:14'), ('user1', 53, '2020-01-06', '17:14') , ('user2', 0005, '2020-11-30', '21:14'), ('user2', 0006, '2020-09-30', '05:55'), ('user2', 0007, '2020-03-06', '13:52'), ('user2', 0008, '2020-05-21', '09:10');
...
CREATE TABLE `flightticketfor` (
  ...
  `type` int NOT NULL, /* 0:one way, 1: round trip */
  `from` varchar(5) NOT NULL,
  `to` varchar(5) NOT NULL,
  `twoLetID` varchar(2) NOT NULL,
  `AircraftID` int NOT NULL,
  `flightNum` int NOT NULL,
  `flightNum2` int NOT NULL,
...
(NULL, 1, 150.00, 25.00, 0, 0, 'EWR', 'LAX', 'AA', 1, 1, 0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'EWR', 'LAX', 'AA', 1, 1,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'EWR', 'LAX', 'AA', 1, 1,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'EWR', 'AA', 1, 2,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'EWR', 'AA', 1, 2,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'EWR', 'AA', 1, 2,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'JFK', 'LAX', 'AA', 1, 3,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'JFK', 'LAX', 'AA', 1, 3,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'JFK', 'LAX', 'AA', 1, 3,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'JFK', 'AA', 1, 4,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'JFK', 'AA', 1, 4,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'JFK', 'AA', 1, 4,0),

(NULL, 1, 150.00, 25.00, 0, 0, 'EWR', 'LAX', 'DL', 1, 5,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'EWR', 'LAX', 'DL', 1, 5,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'EWR', 'LAX', 'DL', 1, 5,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'EWR', 'DL', 1, 6,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'EWR', 'DL', 1, 6,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'EWR', 'DL', 1, 6,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'JFK', 'LAX', 'DL', 1, 7,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'JFK', 'LAX', 'DL', 1, 7,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'JFK', 'LAX', 'DL', 1, 7,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'JFK', 'DL', 1, 8,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'JFK', 'DL', 1, 8,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'JFK', 'DL', 1, 8,0),

(NULL, 1, 150.00, 25.00, 0, 0, 'EWR', 'LAX', 'UA', 1, 9,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'EWR', 'LAX', 'UA', 1, 9,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'EWR', 'LAX', 'UA', 1, 9,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'EWR', 'UA', 1, 10,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'EWR', 'UA', 1, 10,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'EWR', 'UA', 1, 10,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'JFK', 'LAX', 'UA', 1, 11,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'JFK', 'LAX', 'UA', 1, 11,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'JFK', 'LAX', 'UA', 1, 11,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'JFK', 'UA', 1, 12,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'JFK', 'UA', 1, 12,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'JFK', 'UA', 1, 12,0),

(NULL, 1, 150.00, 25.00, 0, 0, 'EWR', 'LAX', 'WN', 1, 13,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'EWR', 'LAX', 'WN', 1, 13,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'EWR', 'LAX', 'WN', 1, 13,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'EWR', 'WN', 1, 14,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'EWR', 'WN', 1, 14,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'EWR', 'WN', 1, 14,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'JFK', 'LAX', 'WN', 1, 15,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'JFK', 'LAX', 'WN', 1, 15,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'JFK', 'LAX', 'WN', 1, 15,0),
(NULL, 1, 150.00, 25.00, 0, 0, 'LAX', 'JFK', 'WN', 1, 16,0), 
(NULL, 2, 400.00, 25.00, 1, 0, 'LAX', 'JFK', 'WN', 1, 16,0), 
(NULL, 3, 1000.00, 25.00, 2, 0, 'LAX', 'JFK', 'WN', 1, 16,0),

/*
Roundtrip
*/

(NULL, 1, 300.00, 25.00, 0, 1, 'EWR', 'LAX', 'AA', 1, 1, 2), 
(NULL, 2, 800.00, 25.00, 1, 1, 'EWR', 'LAX', 'AA', 1, 1, 2), 
(NULL, 3, 2500.00, 25.00, 2, 1, 'EWR', 'LAX', 'AA', 1, 1, 2),

(NULL, 1, 300.00, 25.00, 0, 1, 'EWR', 'LAX', 'DL', 1, 5,6), 
(NULL, 2, 800.00, 25.00, 1, 1, 'EWR', 'LAX', 'DL', 1, 5,6), 
(NULL, 3, 2000.00, 25.00, 2, 1, 'EWR', 'LAX', 'DL', 1, 5,6)
;
...
(0, 'AA', 1, 'EWR', 'LAX', '2021-1-1', '2023-1-2', 0, '5:00', '11:00',4),
(0, 'DL', 1, 'EWR', 'LAX', '2021-1-1', '2023-1-2', 0, '5:00', '11:00',4),
(0, 'UA', 1, 'EWR', 'LAX', '2021-1-1', '2023-1-2', 0, '5:00', '11:00',4),
(0, 'WN', 1, 'EWR', 'LAX', '2021-1-1', '2023-1-2', 0, '5:00', '11:00',4),
...
(6, 'DL', 1, 'LAX', 'EWR', '2022-1-2', '2022-1-4', 0, '8:00', '13:00',2),
