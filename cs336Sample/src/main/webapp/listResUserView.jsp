...
<body>
	<% try {
		out.print("List of User Reservations\n");
		...
		out.print("\n");
		String query = "SELECT b.username AS username, f.flightNum AS flightNum, f.from AS fromy, f.to AS tom, f.class AS class, f.seatNum AS seatNum, f.ticketNum AS ticketNum FROM flightticketfor f, buy b  WHERE f.ticketNum = b.ticketNum ORDER BY username ASC";
