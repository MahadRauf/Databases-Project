...
<body>
	<% try {
		...
		out.print("Revenue Summary for Costumer " + user);		
		...
		//flightticketfor		
		out.print("\n");
		String select = "SELECT SUM(f.totalFare) AS total_fare, SUM(f.bookingFee) AS totalFee, COUNT(f.totalFare) AS totalSold FROM flightticketfor f, buy b  WHERE f.ticketNum = b.ticketNum AND b.username = ?";
