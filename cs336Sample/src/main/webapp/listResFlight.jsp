...
<body>
	<% try {
		...
		out.print("\n");
		String query = "SELECT f.flightNum AS flightNum, b.username AS username, f.from AS fromy, f.to AS tom, f.class AS class, f.seatNum AS seatNum, f.ticketNum AS ticketNum FROM flightticketfor f, buy b  WHERE f.ticketNum = b.ticketNum AND f.flightNum = ?";
		PreparedStatement ps = con.prepareStatement(query);
		ps.setFloat(1, flightNum);
